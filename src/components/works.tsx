...
const Works = () =>{
    ...
    const [Works, setWorks] = React.useState([
        {
            Logo : <p className="text-white text-sm ">SarsHub : Covid-19 Tracker</p>, 
        ...
        {
            Logo :
            <p className="text-white text-sm">Snative SVG Syntax Fixer</p>, 
        ...
        {
            Logo : <p className="text-white text-sm">LandHippo FST Hackathon</p>, 
        ...
        {
            Logo : <p className="text-white text-sm">Solution Bureatique Informatique</p> , 
        ...
        {
            Logo :
            <p className="text-white text-sm">World Currency Converter</p>
            , 
        ...
        {
            Logo : 
            <p className="text-white text-sm">PostLike : API Manager</p>
            , 
        ...
        {
            Logo :
            <p className="text-white text-sm">Instalink LTD</p>, 
        ...
        {
            Logo :
            <p className="text-white text-sm">Inboxify Messages Manager</p>, 
    ...
    //
    return (
        <section className='w-full h-auto pb-10' id="works">
